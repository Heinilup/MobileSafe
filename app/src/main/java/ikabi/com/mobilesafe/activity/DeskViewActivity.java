...
import ikabi.com.mobilesafe.utils.Datum;
 ...
 * @ Data:2016/5/19
 */
public class DeskViewActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DeckView.Callback<Datum> deckViewCallback = new DeckView.Callback<Datum>() {
            ...
            public void unloadViewData(Datum item) {
                Picasso.with(DeskViewActivity.this).cancelRequest(item.target);
            }
            ...
            public void onItemClick(Datum item) {
                Toast.makeText(DeskViewActivity.this,
    ...
    void loadViewDataInternal(final Datum datum,
        ...
        Picasso.with(DeskViewActivity.this).cancelRequest(datum.target);
        ...
        // Begin loading
        Picasso.with(DeskViewActivity.this).load(datum.link).into(datum.target);
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_deck_view, menu);
        return true;
    }
